...
export const register = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: "Welcome to Scrypt Site",
      text: `Welcome to scrypt site. Your account has been created with email id: ${email}`,
    };
...
export const sendRestOtp = async (req, res) => {
  ...
  try {
    ...
    const mailOption = {
      ...
      text: `Your otp for resetting your OTP is ${otp}. use this OTP to proceed with resetting your password.`,
    };
    await transporter.sendMail(mailOption);
